                        ...
                        products.map((product) => (
                            <div key={product.id}>
                                <div className={style.electroCard}>
                                    <img src={product.thumbnail} alt={product.title} style={{ width: "100%", height: "160px" }} />
                                    <p className={style.electroTitle}> {product.title.length > 20 ? `${product.title.slice(0, 20)}...` : product.title}</p>
                                    ...
                                    <div>
                                        ...
                                        </span> {product.brand} Association</p>
                                        <button>Send Enquiry<span>
...
<div>
    <div className={style.electroCard}>
        ...
        <p className={style.electroTitle}>Title</p>
        <p className={style.electroType}>Type</p>
        <p>Rating</p>
